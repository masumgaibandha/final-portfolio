...
export const legalMeta = {
  lastUpdatedLabel: "সর্বশেষ হালনাগাদ: ৯ আগস্ট ২০২৬",
  updateNotice:
  ...
  disclaimer:
    "এই নীতিমালাগুলো MasumDev-এর সার্ভিস কীভাবে পরিচালিত হয় তা সহজ ভাষায় ব্যাখ্যা করার জন্য তৈরি। এটি কোনো আইনি পরামর্শ নয়, এবং আমরা দাবি করি না যে এটি প্রতিটি দেশের প্রতিটি প্রযোজ্য আইনের সাথে সম্পূর্ণভাবে সামঞ্জস্যপূর্ণ।",
} as const;
...
export const privacyPolicy: LegalPageContent = {
  slug: "privacy-policy",
  seoTitle: "Privacy Policy | MasumDev মাস্টারক্লাস",
  metaDescription:
    "MasumDev মাস্টারক্লাসের জন্য কী তথ্য সংগ্রহ করা হয়, কেন এবং কীভাবে সুরক্ষিত রাখা হয়—তার সহজ ব্যাখ্যা।",
  eyebrow: "নীতিমালা",
  heading: "Privacy Policy",
  intro: [
    "এই Privacy Policy ব্যাখ্যা করে MasumDev (পরিচালক: আব্দুল্লাহ আল মাসুম, ওয়েবসাইট: masumdev.com) কীভাবে 2-Day Lead Generation ও Cold Email Outreach মাস্টারক্লাসে রেজিস্ট্রেশনের সময় আপনার তথ্য সংগ্রহ, ব্যবহার এবং সংরক্ষণ করে।",
  ],
  sections: [
    {
      id: "who-we-are",
      ...
      paragraphs: [
        "এই মাস্টারক্লাস ও ওয়েবসাইট masumdev.com পরিচালনা করেন আব্দুল্লাহ আল মাসুম, একজন স্বাধীন freelancer, বাংলাদেশ থেকে। যেকোনো প্রশ্নের জন্য masum@masumdev.com-এ যোগাযোগ করা যাবে।",
      ],
    },
    {
      id: "data-collected",
      ...
      items: [
        ...
        "রেজিস্ট্রেশন ও পেমেন্ট-অর্ডারের status (যেমন: পেমেন্ট pending, সফল, বা ব্যর্থ)",
        "Payment gateway সংযুক্ত হওয়ার পর, payment reference বা transaction-সংক্রান্ত metadata (transaction ID, amount, status)—কখনো সম্পূর্ণ card তথ্য নয়",
        "আপনি কীভাবে এই পেজে এসেছেন তার UTM ও referrer তথ্য",
    ...
    },
    {
      ...
      paragraphs: [
        "MasumDev কখনোই আপনার card-এর PIN, bKash বা Nagad-এর PIN, OTP, অথবা সম্পূর্ণ card নম্বর/CVV সংগ্রহ বা সংরক্ষণ করে না। Payment gateway সংযুক্ত হওয়ার পর সমস্ত সংবেদনশীল পেমেন্ট তথ্য সরাসরি payment provider-এর নিজস্ব নিরাপদ payment page-এ প্রক্রিয়া হবে—আমাদের সার্ভারে নয়।",
      ],
    },
    {
      id: "purposes",
    ...
    },
    {
      ...
      items: [
        ...
        "নির্বাচিত payment provider, gateway সংযুক্ত হওয়ার পর",
        "ইমেইল পাঠানোর জন্য ব্যবহৃত email-delivery provider",
        "Zoom বা ক্লাস পরিচালনার জন্য ব্যবহৃত platform",
        "নিরাপত্তা ও anti-abuse (bot/fraud প্রতিরোধ) provider",
    ...
    {
      id: "analytics-future",
      heading: "১২. ভবিষ্যৎ analytics ও advertising tracking",
      paragraphs: [
        "বর্তমানে এই ওয়েবসাইটে Meta Pixel বা Meta Conversions API (CAPI) সক্রিয় নেই। ভবিষ্যতে এগুলো যুক্ত করা হলে, তার আগে এই Privacy Policy পুনরায় পর্যালোচনা ও হালনাগাদ করা হবে যাতে ঠিক কী ট্র্যাক করা হচ্ছে তা স্পষ্টভাবে জানানো যায়।",
      ],
    },
    {
      id: "updates-privacy",
...
export const termsAndConditions: LegalPageContent = {
  ...
  seoTitle: "Terms and Conditions | MasumDev মাস্টারক্লাস",
  metaDescription:
    "MasumDev-এর 2-Day Lead Generation ও Cold Email Outreach মাস্টারক্লাসে রেজিস্ট্রেশন ও অংশগ্রহণের শর্তাবলী।",
  eyebrow: "নীতিমালা",
  heading: "Terms and Conditions",
  intro: [
    "এই Terms and Conditions MasumDev-এর 2-Day Lead Generation ও Cold Email Outreach মাস্টারক্লাসে রেজিস্ট্রেশন করার আগে পড়ে নিন। রেজিস্ট্রেশন সম্পন্ন করলে আপনি এই শর্তাবলীতে সম্মত হচ্ছেন বলে ধরে নেওয়া হবে।",
  ],
  sections: [
    {
      ...
      paragraphs: [
        "এই মাস্টারক্লাস পরিচালনা করেন আব্দুল্লাহ আল মাসুম (MasumDev), বাংলাদেশ থেকে। অংশ নিতে হলে আপনার বয়স কমপক্ষে ১৮ বছর হতে হবে, অথবা অভিভাবক/guardian-এর মাধ্যমে রেজিস্ট্রেশন সম্পন্ন করতে হবে।",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "বাস্তব ফলাফল নির্ভর করে আপনার দক্ষতা, চর্চা, ধারাবাহিকতা, বাজারের পরিস্থিতি এবং Upwork/Fiverr বা email service provider-দের নিজস্ব নিয়মাবলীর উপর—এর কোনোটির উপরই MasumDev-এর সরাসরি নিয়ন্ত্রণ নেই।",
      ],
    },
    {
      id: "course-details",
      ...
      paragraphs: [
        "ফি: ৳২,০০০। লাইভ ক্লাস তারিখ: ২ ও ৩ অক্টোবর ২০২৬, Zoom-এর মাধ্যমে লাইভ। রেজিস্ট্রেশনকৃত শিক্ষার্থীরা লাইভ ক্লাস শেষ হওয়ার পর ৭ দিন recording-এর মাধ্যমে ক্লাসগুলো দেখতে পারবেন।",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "রেজিস্ট্রেশনের সময় আপনাকে সঠিক নাম, ইমেইল ও মোবাইল নম্বর দিতে হবে। ভুল তথ্যের কারণে confirmation বা ক্লাসে প্রবেশাধিকার পেতে সমস্যা হলে তার দায় MasumDev-এর নয়।",
      ],
    },
    {
      id: "one-seat",
      ...
      paragraphs: [
        "একটি রেজিস্ট্রেশন শুধুমাত্র একজন অংশগ্রহণকারীর জন্য প্রযোজ্য। Seat অন্য কারও নামে transfer করতে হলে আগে থেকে লিখিতভাবে MasumDev-এর অনুমোদন নিতে হবে।",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "গুরুতর অসদাচরণ, ক্লাসে বিঘ্ন সৃষ্টি, piracy (কনটেন্ট চুরি) বা প্রতারণামূলক payment-এর ক্ষেত্রে MasumDev কোনো অংশগ্রহণকারীকে ক্লাস থেকে অপসারণ করতে পারে। এমন পরিস্থিতিতে রিফান্ডের কোনো প্রতিশ্রুতি দেওয়া হয় না।",
      ],
    },
    {
      id: "schedule-changes",
...
export const refundPolicy: LegalPageContent = {
  slug: "refund-policy",
  seoTitle: "Refund Policy | MasumDev মাস্টারক্লাস",
  metaDescription:
    "MasumDev-এর মাস্টারক্লাসের জন্য কখন রিফান্ড প্রযোজ্য, কখন নয়, এবং কীভাবে অনুরোধ করবেন—তার সম্পূর্ণ ব্যাখ্যা।",
  eyebrow: "নীতিমালা",
  heading: "Refund Policy",
  intro: [
    "এই Refund Policy স্পষ্টভাবে ব্যাখ্যা করে MasumDev-এর 2-Day মাস্টারক্লাসের জন্য কখন রিফান্ড দেওয়া হয় এবং কখন দেওয়া হয় না।",
  ],
  sections: [
    {
      id: "general-rule",
    ...
    },
    {
      ...
      items: [
        "MasumDev নিজে মাস্টারক্লাসটি বাতিল করলে—সেক্ষেত্রে সকল রেজিস্ট্রেশনকৃত শিক্ষার্থী পূর্ণ রিফান্ড পাবেন।",
        "MasumDev উভয় লাইভ ক্লাসের তারিখই payment-এর পর ভিন্ন তারিখে পরিবর্তন করলে, এবং একজন শিক্ষার্থী নতুন তারিখে অংশ নিতে না পারলে—নতুন ক্লাস শুরু হওয়ার আগে অনুরোধ করলে পূর্ণ রিফান্ড দেওয়া হবে।",

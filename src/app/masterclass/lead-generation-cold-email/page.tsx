...
import { currency, earlyBirdPriceBDT, regularPriceBDT, resolvePriceBDT } from "@/lib/masterclass/constants";
 ...
 * regenerates this page *within that same deployment*, so a changed env
 * var only takes effect after an actual redeploy, same as it would for a
 * fully static page. There's no way around that from inside the app; it's
 * how Vercel resolves environment variables. See the launch report's
 * "Manual Steps Before Launch" for the practical implication: after
 * changing any masterclass env var in Vercel, redeploy before assuming the
 * change is live.
 */

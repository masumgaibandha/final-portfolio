      ...
      <Container className="pt-10 pb-14 md:pt-14 md:pb-16">
        <div className="grid items-center gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:gap-12">
          <div>
            ...
            {/*
             * Not `type-display`: that clamp (up to 66px) is tuned for the
             * homepage's short two-line headline. This headline runs much
             * longer, so it gets its own smaller, looser-leading clamp — at
             * ~1280-1440px this lands around 4-5 balanced lines instead of
             * 7-8 cramped ones. `text-balance` still evens the last line.
             */}
            <h1

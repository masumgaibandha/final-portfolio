 ...
 * key being reused for a genuinely different request (different
 * registration, amount, currency, or batch) — never logged, and the
 * canonical source string is discarded immediately after hashing.
 */
